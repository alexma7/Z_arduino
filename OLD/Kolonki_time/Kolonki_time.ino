...
//Инфракрасный пульт
 if (irrecv.decode(&results)) 
  ...
  Serial.println("/home/hall/termistr@"+String(float(Thermister(analogRead(2))),1)+"%"); 
...
delay(500);
if (isnan(h) || isnan(t)) {
Serial.println("Not working DHT11");
return;
}
      /*Serial.print(" DHT: "); 
    Serial.print(t); 
  ...
  Serial.print(h); 
    Serial.println(" %\t");  */ 
	//delay(500);  
  Serial.println("/home/hall/dht11t@"+String(t)+"%");
//delay(500);  
  Serial.println("/home/hall/dht11h@"+String(h)+"%"); 
  //delay(500);  
...
void sendToMQTT ()
{
  ...
  if (strAdr != "" || strVal != "" )
  {
	  if (strAdr=="/home/hall/ard1relay1")
